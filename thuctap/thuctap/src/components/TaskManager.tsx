...
const STATIC_PROJECTS: Project[] = [
  { id: 'PN0001245', name: 'Ứng dụng Y tế (iOS Nguyên bản - Native)', description: 'Xem xét thiết kế UX đăng nhập & đăng ký, phát triển giao diện Native Swift và tích hợp API y tế.', reporter: 'Kim Kim Tiểu Trương', priority: 'high', dueDate: '2026-12-31', assignees: ['u-1', 'u-2', 'u-3'] },
  { id: 'PN0001246', name: 'Hệ thống dịch vụ giao đồ ăn (Food Delivery)', description: 'Hệ thống vận chuyển đồ ăn nhanh và tối ưu hóa tuyến đường giao hàng tự động.', reporter: 'Vương Nhất Dược', priority: 'medium', dueDate: '2026-10-15', assignees: ['u-1', 'u-4'] },
  { id: 'PN0001247', name: 'Trang web doanh nghiệp Fortune', description: 'Trang thông tin doanh nghiệp tập đoàn Fortune với giao diện bento-grid và 3D Spline.', reporter: 'Lý Hạc Loan', priority: 'low', dueDate: '2026-08-30', assignees: ['u-2', 'u-3'] },
  { id: 'PN0001248', name: 'Ứng dụng Lập kế hoạch (Planner)', description: 'Ứng dụng lập kế hoạch cá nhân tích hợp trợ lý ảo nhắc nhở bằng giọng nói.', reporter: 'Kim Kim Tiểu Trương', priority: 'medium', dueDate: '2026-11-20', assignees: ['u-3', 'u-4'] },
  { id: 'PN0001249', name: 'Bộ theo dõi thời gian (Time Tracker)', description: 'Phần mềm đếm giờ làm việc tự động chụp màn hình và phân loại hiệu suất AI.', reporter: 'Đoạn Hân Duyệt', priority: 'low', dueDate: '2026-09-01', assignees: ['u-1', 'u-2'] },
  { id: 'PN0001250', name: 'Hệ thống dự án nội bộ JIN', description: 'Cổng thông tin dự án nội bộ tích hợp lưu trữ tập trung tài liệu JIN.', reporter: 'Lý Hạc Loan', priority: 'high', dueDate: '2026-12-05', assignees: ['u-1', 'u-2', 'u-3', 'u-4'] }
];
...
export const INITIAL_TASKS: CustomTask[] = [
  {
    id: 'TSK-201',
    projectId: 'PN0001245',
    title: 'Trải nghiệm người dùng Đăng nhập + Đăng ký',
    group: 'Thiết kế UI/UX',
    priority: 'medium',
    estimatedTime: '3 ngày 8 giờ',
    estimatedHours: 32,
    actualTime: '1 ngày 3 giờ',
    actualHours: 11,
    assigneeId: 'u-1',
    status: 'in_progress',
    description: 'Xem xét UX của đăng nhập và đăng ký, tạo wireframe quy trình làm việc và lặp lại thiết kế cùng đội ngũ.',
    attachments: [
      { name: 'Wireframe Đăng nhập.png', size: '2.4 MB', date: '2026-07-01' },
      { name: 'Wireframe Đăng ký.png', size: '1.8 MB', date: '2026-07-02' }
    ],
    journal: [
      { user: 'Kim Kim Tiểu Trương', action: 'đã tạo nhiệm vụ', date: '2026-06-30 09:12' },
      { user: 'Kim Kim Tiểu Trương', action: 'đã chuyển trạng thái sang Đang tiến hành', date: '2026-07-01 10:45' },
      { user: 'Đoạn Hân Duyệt', action: 'đã đính kèm 2 tệp wireframe thiết kế', date: '2026-07-02 14:00' }
    ]
  },
  {
    id: 'TSK-202',
    projectId: 'PN0001245',
    title: 'Thiết kế Bản đồ tư duy',
    group: 'Thiết kế UI/UX',
    priority: 'high',
    ...
    assigneeId: 'u-2',
    status: 'in_progress',
    description: 'Xây dựng luồng người dùng cốt lõi cho ứng dụng y tế di động native sử dụng các công cụ vẽ sơ đồ XMind/Figma.',
    attachments: [],
    journal: [
      { user: 'Kim Kim Tiểu Trương', action: 'đã giao việc cho Vương Nhất Dược', date: '2026-07-01 09:00' }
    ]
  },
  {
    id: 'TSK-203',
    projectId: 'PN0001245',
    title: 'Bản phác thảo Trải nghiệm người dùng',
    group: 'Thiết kế UI/UX',
    priority: 'low',
    ...
    assigneeId: 'u-3',
    status: 'done',
    description: 'Phác thảo bảng trắng độ phân giải thấp ban đầu cho màn hình onboarding của bác sĩ và bệnh nhân.',
    attachments: [{ name: 'PhacThaoBangTrang.jpg', size: '4.5 MB', date: '2026-07-02' }],
    journal: [
      { user: 'Kim Kim Tiểu Trương', action: 'đã tạo nhiệm vụ vào 2026-06-25', date: '2026-06-25 10:00' },
      { user: 'Lý Hạc Loan', action: 'đã hoàn thành nhiệm vụ', date: '2026-06-28 17:30' }
    ]
  },
  {
    id: 'TSK-204',
    projectId: 'PN0001245',
    title: 'Phỏng vấn Trải nghiệm người dùng + Đăng ký',
    group: 'Thiết kế UI/UX',
    priority: 'medium',
    estimatedTime: '4 ngày',
    estimatedHours: 32,
    actualTime: '2 days (2 ngày)',
    actualHours: 16,
    assigneeId: 'u-4',
    status: 'in_progress',
    description: 'Lên lịch phỏng vấn video với 5 nhân viên y tế để xem xét các quy trình và ràng buộc đăng ký bảo mật.',
    attachments: [],
    journal: []
  },
  {
    id: 'TSK-205',
    projectId: 'PN0001245',
    title: 'Thiết kế UI Đăng nhập + Đăng ký',
    group: 'Thiết kế UI/UX',
    priority: 'high',
    ...
    assigneeId: 'u-1',
    status: 'in_progress',
    description: 'Thiết kế giao diện Figma độ trung thực cao với các trạng thái kích hoạt cục bộ, nhập liệu và kiểm tra lỗi.',
    attachments: [],
    journal: []
  },
  {
    id: 'TSK-206',
    projectId: 'PN0001245',
    title: 'Các giao diện UI phụ khác',
    group: 'Thiết kế UI/UX',
    priority: 'low',
    ...
    assigneeId: 'u-2',
    status: 'in_progress',
    description: 'Thiết kế các màn hình phụ bao gồm cài đặt ứng dụng, ma trận thông báo và nhật ký các cuộc hẹn.',
    attachments: [],
    journal: []
  },
  {
    id: 'TSK-207',
    projectId: 'PN0001245',
    title: 'Ví dụ hoạt ảnh nút bấm',
    group: 'Thiết kế tương tác',
    priority: 'low',
    estimatedTime: '8 giờ',
    estimatedHours: 8,
    actualTime: '0 giờ',
    ...
    assigneeId: 'u-3',
    status: 'todo',
    description: 'Thiết kế tương tác vi mô và hiệu ứng lò xo cho các nút bấm chính trong Swift.',
    attachments: [],
    journal: []
  },
  {
    id: 'TSK-208',
    projectId: 'PN0001245',
    title: 'Hoạt ảnh trang đích (Preloader)',
    group: 'Thiết kế tương tác',
    priority: 'medium',
    ...
    assigneeId: 'u-4',
    status: 'todo',
    description: 'Tạo mẫu bộ tải xương (skeleton loader) uyển chuyển với màu sắc thương hiệu và hiệu ứng tỏa sáng.',
    attachments: [],
    journal: []
  }
];
...
export const TaskManager: React.FC<TaskManagerProps> = ({ currentUser, users }) => {
  ...
  const [selectedProjectId, setSelectedProjectId] = useState<string>('PN0001245');
    ...
    <div className="p-4 sm:p-6 bg-[#ebf0f5] min-h-screen font-sans text-slate-700 flex flex-col justify-between" id="project-management-workspace">
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-12 gap-6 items-start">
          ...
          <div className="xl:col-span-3 space-y-5">
            <div className="bg-white rounded-2xl p-5 border border-[#e2eae8] shadow-sm">
            ...
            <div className="bg-white rounded-2xl p-5 border border-[#e2eae8] shadow-sm space-y-4">
          ...
          <div className="xl:col-span-9 space-y-5">
            ...
            {/* Header action bar */}
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-white p-5 rounded-2xl border border-[#e2eae8] shadow-sm">
            ...
            <div className="flex justify-between items-center bg-white p-3.5 rounded-2xl border border-[#e2eae8] shadow-sm">
            ...
            {currentProjectTasks.length === 0 ? (
              ...
              <div className="bg-white rounded-2xl border border-[#e2eae8] p-12 text-center shadow-sm">
              ...
              <>
                ...
                {viewMode === 'list' && (
                  <div className="space-y-6">
                    ...
                    {/* Current Tasks Table */}
                    <div className="bg-white rounded-2xl border border-[#e2eae8] overflow-hidden shadow-sm">
                ...
                {viewMode === 'kanban' && (
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5 items-start">
                    ...
                    <div className="bg-slate-50/80 rounded-2xl p-4 border border-[#e2eae8] space-y-4">
                ...
                {(viewMode === 'gantt' || viewMode === 'timeline') && (
                  <div className="bg-white p-6 rounded-2xl border border-[#e2eae8] shadow-sm space-y-5">
          ...
          <div className="w-full max-w-4xl bg-white h-full relative z-10 shadow-2xl overflow-y-auto flex flex-col justify-between animate-slide-left font-sans text-slate-700">
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
                ...
                <div className="lg:col-span-4 space-y-5 bg-slate-50/50 p-5 rounded-2xl border border-[#e2eae8]">
      ...
      {statusConfirmTask && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          {/* Modal Container */}
          <div className="bg-white rounded-2xl border border-slate-100 shadow-2xl w-full max-w-md z-10 overflow-hidden relative animate-scale-up font-sans text-slate-700">
            ...
            <div className="p-6 space-y-4 text-center">
              ...
              <div className="w-full h-40 bg-gradient-to-b from-[#f3f7ff] to-white rounded-2xl p-4 flex items-center justify-center border border-blue-50/50">
      ...
      {isAddTaskOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="bg-white rounded-2xl border border-slate-100 shadow-2xl w-full max-w-lg z-10 overflow-hidden relative animate-scale-up font-sans text-slate-700">
            <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100 bg-slate-50/50">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="bg-white rounded-2xl border border-slate-100 shadow-2xl w-full max-w-lg z-10 overflow-hidden relative animate-scale-up font-sans text-slate-700">
            ...
            <form onSubmit={handleRecordTimeSubmit} className="p-6 space-y-4">
              ...
              <div className="w-full h-36 bg-gradient-to-b from-[#f3f7ff] to-white rounded-2xl p-4 flex items-center justify-center border border-blue-50/50 relative overflow-hidden">
