            ...
            <div className="p-4 border-b border-slate-100 bg-slate-50/50 flex justify-between items-center shrink-0">
              <div>
                <h3 className="text-xs font-extrabold text-slate-800 flex items-center gap-1.5">
                  ...
                  Kho Lưu Trữ Đám Mây Nhân Sự (Siohioma Cloud)
                </h3>
                  ...
                  >
                    ...
                    <div className="space-y-1 text-left flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div className={`p-3 rounded-2xl text-xs leading-relaxed whitespace-pre-wrap flex-1 ${bubbleColor} ${isMe ? 'rounded-tr-sm' : 'rounded-tl-sm'} relative group/msg ${isLocal && !isFailed ? 'opacity-65' : ''}`}>
                          {msg.replyTo && (
              ...
              <div className="flex space-x-2 items-center">
                ...
                <div className="flex-1 relative flex items-center">
                  ...
                  {showEmojiPicker && (
                    <div
                      ref={emojiPickerRef}
                      className="absolute bottom-12 right-0 bg-white border border-slate-100 rounded-2xl shadow-xl p-3 w-64 z-40 animate-fade-in"
                    >
